...
public interface OrderDetailRepository extends JpaRepository<OrderDetails, Long> {
    ...
    @Query(value = "WITH RECURSIVE month_range AS ( " +
            ...
            "GROUP BY time " +
            "ORDER BY time", nativeQuery = true)
    List<StatOderProjection> statisticOrderQuater(Date startDate, Date endDate, Long id);
    ...
    @Query(value = "WITH RECURSIVE month_range AS ( " +
            ...
            "GROUP BY time " +
            "ORDER BY time", nativeQuery = true)
    List<StatOderProjection> statisticOrderYear(Date startDate, Date endDate, Long id);
